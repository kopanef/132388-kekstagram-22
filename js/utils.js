...
// Функция вытаскивает рандомный элемент из массива при помощи метода Лодэш
...
export { createPhoto, createComment, getRandomInt, CheckLength, getRandomArrayElement };
